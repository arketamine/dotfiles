...
complete -c fnm -n "__fish_use_subcommand" -l multishell-path -d 'Where the current node version link is stored. This value will be populated automaticallyby evaluating `fnm env` in your shell profile. Read more about it using `fnm help env`' -r
...
complete -c fnm -n "__fish_seen_subcommand_from install" -l version -d 'Printversion information'
...
complete -c fnm -n "__fish_seen_subcommand_from completions" -l shell -d 'Theshell syntax to use. Infers when missing' -r
...
complete -c fnm -n "__fish_seen_subcommand_from alias" -l help -d 'Print helpinformation'
...
complete -c fnm -n "__fish_seen_subcommand_from unalias" -l version -d 'Printversion information'
complete -c fnm -n "__fish_seen_subcommand_from default" -l help -d 'Print help information'
complete -c fnm -n "__fish_seen_subcommand_from default" -l version -d 'Printversion information'
complete -c fnm -n "__fish_seen_subcommand_from current" -l help -d 'Print help information'
complete -c fnm -n "__fish_seen_subcommand_from current" -l version -d 'Printversion information'
